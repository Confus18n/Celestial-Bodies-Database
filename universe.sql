...
--
-- Name: missions mission_id; Type: DEFAULT; Schema: public; Owner: freecodecamp
--
...
INSERT INTO public.missions VALUES (1, 'Apollo 11', 1, 1, 1969, 'NASA', true);
INSERT INTO public.missions VALUES (2, 'Mars Pathfinder', 2, NULL, 1996, 'NASA', true);
INSERT INTO public.missions VALUES (3, 'Kepler Observer', 3, 4, 2015, 'NASA', true);
INSERT INTO public.missions VALUES (4, 'Proxima Surveyor', 4, 5, 2022, 'ESA', true);
INSERT INTO public.missions VALUES (5, 'TRAPPIST Mission', 5, 6, 2023, 'ESA', true);
INSERT INTO public.missions VALUES (6, 'Sirius Probe', 6, 7, 2010, 'Roscosmos', false);
INSERT INTO public.missions VALUES (7, 'Rigel Explorer', 7, 8, 2018, 'NASA', true);
INSERT INTO public.missions VALUES (8, 'Andromeda Venture', 9, 10, 2021, 'SpaceX', true);
INSERT INTO public.missions VALUES (9, 'Europa Clipper', 18, 14, 2024, 'NASA', true);
INSERT INTO public.missions VALUES (10, 'Titan Recon', 19, 17, 2025, 'NASA', true);
...
INSERT INTO public.stars VALUES (1, 'Sun', 'G', 1, 0.0, 1);
INSERT INTO public.stars VALUES (2, 'Sirius', 'A', 2, 8.6, 1);
INSERT INTO public.stars VALUES (3, 'Proxima Centauri', 'M', 0, 4.2, 1);
INSERT INTO public.stars VALUES (4, 'Rigel', 'B', 18, 860.0, 1);
INSERT INTO public.stars VALUES (5, 'Alpha Andromedae', 'B', 4, 97.0, 2);
INSERT INTO public.stars VALUES (6, 'R136a1', 'Wolf-Rayet', 315, 163000.0, 4);
...
--
-- Name: missions missions_target_moon_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.missions
    ADD CONSTRAINT missions_target_moon_id_fkey FOREIGN KEY (target_moon_id) REFERENCES public.moon(moon_id) ON DELETE SET NULL;


--
-- Name: missions missions_target_planet_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.missions
    ADD CONSTRAINT missions_target_planet_id_fkey FOREIGN KEY (target_planet_id) REFERENCES public.planet(planet_id);
...
ALTER TABLE ONLY public.planet
    ADD CONSTRAINT planet_star_id_fkey FOREIGN KEY (star_id) REFERENCES public.stars(star_id);
